...
Gem::Specification.new do |spec|
  ...
  spec.homepage = "https://github.com/marcosgz/esse-async-indexing"
  spec.license = "MIT"
  spec.required_ruby_version = ">= 2.7.0"

  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = "https://github.com/marcosgz/esse-async-indexing"
  spec.metadata["changelog_uri"] = "https://github.com/marcosgz/esse-async-indexing/blob/main/CHANGELOG.md"
